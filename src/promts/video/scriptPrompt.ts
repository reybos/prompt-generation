...
Introduction (greeting with main character)
Main scenes (3-5 scenes with main character + secondary characters)
Finale (question or call to action for the child)
